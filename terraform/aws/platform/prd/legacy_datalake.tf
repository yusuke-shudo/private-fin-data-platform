# =========================================================================
# 【廃止予定】旧データレイク一式（private-fin-data-lake-*）
# datalake.tf の新バケットへ移行完了後、このファイルごと削除して apply する。
# アドレスも定義内容も意図的に旧のまま据え置き（plan に差分を出さないため）。
# =========================================================================
...
output "legacy_s3_access_point_alias" {
  value       = aws_s3_access_point.sf_ap.alias
  description = "【廃止予定】旧アクセスポイントのエイリアス"
}
