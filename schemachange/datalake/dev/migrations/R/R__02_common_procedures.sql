...
ALTER PROCEDURE datalake_db.common.proc_load_raw_full_refresh(VARCHAR, VARCHAR, VARCHAR, VARCHAR)
...
CREATE OR REPLACE PROCEDURE datalake_db.common.proc_load_raw_from_stream(
    ...
    BEGIN
      ...
      IF (dataset_config_item IS NOT NULL) THEN
        CALL datalake_db.common.proc_load_raw_full_refresh(
          ...
          :dataset_config_item:file_pattern::VARCHAR
        );
...
ALTER PROCEDURE datalake_db.common.proc_load_raw_from_stream(VARCHAR, VARCHAR, VARCHAR, VARIANT)
  SET TAG common_db.governance.object_managed_by = 'schemachange'
;
